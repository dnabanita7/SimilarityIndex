...
for i in range(43):
  content = face_recognition.load_image_file("portraits/students"+ str(i).zfill(2) +".png")
    ...
    while True:
        ...
        if not success:
            ...
            for face_encoding in face_encodings:
                ...
                matches = face_recognition.compare_faces(students_face_encodings, face_encoding)
                name = "Unknown"
