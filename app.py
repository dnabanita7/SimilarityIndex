...
def detect_faces(face_encodings):
    face_names = []
    ...
    yield face_names, second_face_names, third_face_names, percentage_similarities, second_percentage_similarities, third_percentage_similarities

def process_frame(frame, rgb_small_frame):
    if process_this_frame:
            ...
            third_face_names = []
            third_percentage_similarities = []
            for det in detect_faces(face_encodings):
                face_names, second_face_names, third_face_names, percentage_similarities, second_percentage_similarities, third_percentage_similarities = det
            # Display the results
            for (
...
def gen(camera):
    while True:
        ...
        process_frame(frame, rgb_small_frame)
...
def index():
    ...
    print(detect_faces(face_encodings), file=stderr)
